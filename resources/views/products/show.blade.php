        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('home') }}"
                                class="ml-1 text-gray-700 hover:text-indigo-600 md:ml-2">Products</a>
                        </div>
                    </li>
            ...
            <div class="mb-16 grid grid-cols-1 gap-12 lg:grid-cols-2">
                ...
                <div class="space-y-4">
                    <div class="aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-gray-200">
                        <img :src="product.image" :alt="product.name" class="h-96 w-full object-cover">
                    </div>
                    <div class="grid grid-cols-4 gap-4">
                        <template x-for="(image, index) in product.images" :key="index">
                            <div
                                class="aspect-w-1 aspect-h-1 cursor-pointer overflow-hidden rounded-lg bg-gray-200 hover:ring-2 hover:ring-indigo-500">
                ...
                <div class="space-y-6">
                    <div>
                        <h1 class="mb-2 text-3xl font-bold text-gray-900" x-text="product.name"></h1>
                        <div class="mb-4 flex items-center space-x-4">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-600"
                                    x-text="product.rating + ' (' + product.reviews + ' reviews)'"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center rounded-lg border border-gray-300">
                            ...
                            <input type="number" x-model="quantity" min="1"
                                class="w-16 border-0 text-center focus:ring-0" readonly>
                            <button @click="quantity = quantity + 1" class="px-3 py-2 text-gray-600 hover:text-gray-800">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Add to Cart Button -->
                    <div class="space-y-4">
                        <button @click="addToCartWithQuantity()" :disabled="!product.inStock"
                            :class="product.inStock ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-gray-400 cursor-not-allowed'"
                            class="w-full rounded-lg px-6 py-3 font-semibold text-white transition duration-300">
                            <span x-text="product.inStock ? 'Add to Cart' : 'Out of Stock'"></span>
                        </button>

                        <button
                            class="w-full rounded-lg border border-indigo-600 px-6 py-3 font-semibold text-indigo-600 transition duration-300 hover:bg-indigo-50">
                            Add to Wishlist
                        </button>
                    </div>
                    ...
                    <div class="border-t pt-6">
                        <h3 class="mb-4 text-lg font-semibold text-gray-900">Product Features</h3>
                        <ul class="space-y-2">
            ...
            <div class="border-t pt-16">
                <div class="mb-12 text-center">
                    <h2 class="mb-4 text-3xl font-bold text-gray-900">Recommended for You</h2>
