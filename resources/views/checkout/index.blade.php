        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                            ...
                            <div class="mb-6 rounded-lg border border-gray-200 bg-white shadow-sm">
                                ...
                                <div class="space-y-4 p-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" x-model="shippingInfo.email"
                                            class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-indigo-500"
                                            required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" x-model="shippingInfo.phone"
                                            class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-indigo-500"
                                            required>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                        <div>
                                            ...
                                            <input type="text" x-model="shippingInfo.city"
                                                class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-indigo-500"
                                                required>
                                        </div>
                                        <div>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
                                ...
                                <div class="p-6">
                                    ...
                                    <button type="submit" :disabled="processing"
                                        :class="processing ? 'bg-gray-400 cursor-not-allowed' :
                                            'bg-indigo-600 hover:bg-indigo-700'"
                                        class="w-full rounded-lg px-4 py-3 font-semibold text-white transition duration-300">
                                        <span x-show="!processing">Place Order - $<span
                                                x-text="getGrandTotal().toFixed(2)"></span></span>
                                    ...
                                    <template x-for="item in items" :key="item.id">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <p class="truncate text-sm font-medium text-gray-900" x-text="item.name">
                                                </p>
                                                <p class="text-sm text-gray-500">Qty: <span x-text="item.quantity"></span>
                                                </p>
                                            </div>
            ...
            <div x-show="items.length === 0" class="py-16 text-center">
                <div class="mx-auto max-w-md">
                    ...
                    <p class="mb-8 text-gray-600">You need to add items to your cart before checkout.</p>
                    <a href="{{ route('home') }}"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('checkout', () => ({
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data.has_out_of_stock) {
                                ...
                                const itemNames = data.out_of_stock_items.map(item => item.name)
                                    .join(', ');
                ...
                generateOrderToken() {
                    ...
                    return 'order_' + btoa(JSON.stringify(data)).replace(/[^a-zA-Z0-9]/g, '').substring(
                        0, 32);
                },
                    ...
                    try {
                        ...
                        if (!response.ok) {
                            ...
                            if (responseData.error_type === 'stock_issue') {
                                const itemNames = responseData.out_of_stock_items.map(item => item
                                    .name).join(', ');
